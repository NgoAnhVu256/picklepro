          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/products">
                <Button 
                  size="lg" 
                  className="bg-lime hover:bg-lime-dark text-lime-dark hover:text-white font-bold rounded-full px-8 py-6 text-lg shadow-xl shadow-lime/40 transition-all hover:scale-105"
                >
                  Khám phá ngay
              ...
              <Link href="/products">
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-lime/50 text-lime-dark hover:bg-lime/10 font-semibold rounded-full px-8 py-6 text-lg"
                >
                  Xem khuyến mãi
                </Button>
              </Link>
