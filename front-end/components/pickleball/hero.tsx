...
export function Hero() {
  ...
  if (loading) {
    return (
      <section className="py-6 md:py-10 bg-[#0B0A11]">
  ...
  return (
    <section className="py-6 md:py-10 bg-[#0a0a0c]">
      <div className="container mx-auto px-4">
        <h2 className="text-xl md:text-2xl font-bold text-white mb-6 uppercase tracking-wider flex items-center gap-2">
          <span className="w-2 h-6 bg-lime block rounded-sm" /> 
          Sản phẩm bán chạy
        </h2>

        {/* Horizontal Scroll Carousel */}
        <div className="flex overflow-x-auto hide-scrollbar gap-4 md:gap-6 pb-6 snap-x snap-mandatory">
